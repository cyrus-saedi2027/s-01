...
/** The hero headline is animated one character at a time, so it ships as tokens. */
export const heroLine = [
  { text: "an", tone: "dim" },
  { text: "independent", tone: "solid" },
  { text: "creative", tone: "dim" },
  { text: "Designer", tone: "solid" },
  { text: "&", tone: "accent" },
  { text: "Developer", tone: "solid" },
  { text: "based", tone: "dim" },
  { text: "in", tone: "dim" },
  { text: "Netherlands", tone: "solid" },
] as const;
...
export const navLinks = ["Home", "About", "Projects", "Playground", "Contact"];
